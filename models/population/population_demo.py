#!/usr/bin/env python3
"""
用途: 生物种群模型 Demo 脚本（Logistic / Lotka-Volterra / SIR）
输入: 无（参数均在脚本内定义）
输出: 控制台打印结果；output/population_result.png (300dpi)
调用: python population_demo.py
"""
...
def sir(t, y, N, beta, gamma):
    """SIR 模型: dS/dt = -beta S I/N, dI/dt = beta S I/N - gamma I, dR/dt = gamma I"""
    S, I, R = y
    return [-beta * S * I / N,
            beta * S * I / N - gamma * I,
            gamma * I]
